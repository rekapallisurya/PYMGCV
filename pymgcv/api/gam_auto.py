...
def fit_with_selection(
    ...
    Example:
        ...
        >>> print(model.summary())
    """
    selector = VariableSelector(data, formula, family=family, criterion=criterion, verbose=verbose)
    ...
    def select(
        ...
        for step in range(max_steps):
            ...
            if min_effect < threshold:
                # Drop this variable
                self.current_formula = self._remove_variable(self.current_formula, min_effect_var)
